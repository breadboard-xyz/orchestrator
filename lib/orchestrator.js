                  ...
                  .on('/create', (msg = {}, cb) => {
                    ...
                    return codedb_sdk
                            ...
                            .then((result) => {
                              ...
                              return Sandbox
                                      ...
                                      .then((service) => {
                                        ...
                                        let transform = (body) => {
                                          let port = _.chain(body).first().get('Endpoint.Ports').find(['TargetPort', 8080]).get('PublishedPort').value();
                                          ...
                                          let protocol  = config.get('sandbox.loadbalancer.protocol')
                                            ...
                                            ;
                                          console.log(id, image, secret, protocol, hostname, port);
                            ...
                            .tap(({ id, protocol, hostname, port }) => {
                              console.log(id, protocol, hostname, port);
