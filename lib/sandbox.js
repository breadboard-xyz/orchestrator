...
class Sandbox {
  ...
  static list(options = {}) {
    let ssl = { cert, key, passphrase, ca };

    return api({ protocol, hostname, port, pathname : `/services`, ...ssl, ...options });
  }

  static inspect(id, options = {}) {
    let ssl = { cert, key, passphrase, ca };

    return api({ protocol, hostname, port, pathname : `/services/${id}`, ...ssl, ...options });
  }
  ...
  static delete(id, options = {}) {
    ...
    return api({ method : 'DELETE', protocol, hostname, port, pathname : `/services/${id}`, json : false, ...ssl, ...options });
  }
  ...
  static create(name, image, options = {}) {
    ...
    return api({ method : 'POST', protocol, hostname, port, pathname : `/services/create`, headers, body, ...ssl });
  }
