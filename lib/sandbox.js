...
class Sandbox {
  ...
  static list(options = {}) {
    ...
    return api({ hostname, port, pathname : `/services`, ...ssl, ...options });
  }

  static inspect(id, options = {}) {
    let ssl = { cert, key, passphrase, ca };

    return api({ hostname, port, pathname : `/services/${id}`, ...ssl, ...options });
  }
  ...
  static delete(id, options = {}) {
    ...
    return api({ method : 'DELETE', hostname, port, pathname : `/services/${id}`, json : false, ...ssl, ...options });
  }
  ...
  static create(name, image, options = {}) {
    ...
    return api({ method : 'POST', hostname, port, pathname : `/services/create`, headers, body, ...ssl });
  }
